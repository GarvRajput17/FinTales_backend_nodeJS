...
app.get('/', (req, res) => {
  res.json({
    message: 'Welcome to FinTales API',
...
app.post('/api/generate', async (req, res) => {
  try {
    ...
    // Forward to FastAPI with extracted fields
    const response = await axios.post(`${PYTHON_API_URL}/api/generate`, {
      difficulty,
      topic,
      subtopic
    });
    console.log("Recieved topic name:", topic);
    console.log("Recieved subtopic name:", subtopic);
